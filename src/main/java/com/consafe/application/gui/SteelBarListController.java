...
public class SteelBarListController implements Initializable, DataChangeListener {
	...
	public void onBtNewAction(ActionEvent event) {
		...
		createDialogForm(obj, "/com/consafe/application/gui/SteelBarForm.fxml", parentStage);
	}
	...
	private void initializeNodes() {
		tableColumnCategory.setCellValueFactory(new PropertyValueFactory<>("steelBarCategory".toString()));
...
//				}
//				setGraphic(button);
//				button.setOnAction(event -> createDialogForm(obj, "/com/consafe/application/gui/SteelBarForm.fxml",
